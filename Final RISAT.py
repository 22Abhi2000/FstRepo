...
def connect_menu_init():
    global root,output_text,END,NORMAL,Button,Label,Entry,LabelFrame,Frame,Tk,Canvas,OptionMenu,header_label
    ...
    global frame9,cb,icb,drift,isd,last_cmd_b1_b2,last_cmd_b3,last_cmd_b4,acq1_svid,port1,port2
    global frame10,pdop
    global frame11,swdt,lbl,entry,lrt,SI,iode,crs,odp,phase_center,phase_center_sps
    global frame13,btn
    global status_var,bus_var,dataword_entry,gui_entry_dict,wdt_entries,word25_entries
    global frame14,lbl,entry,label,ttf,TTF
    global frame_cndr_plot,ax_cndr,canvas_cndr,cmd_btn,btn_replay
    window = Tk()
    window.title("RISAT 12 CHANNNEL INTERFACE")
    window.configure(bg="lavender")
    window.geometry("1400x800")
    
    project_name_var = StringVar(value="RISAT")

    # === Header Banner ===
    header_label = Label(
        window,
        text="RISAT TELEMETRY AND COMMAND INTERFACE",
    ...
    def update_project_name(*args):
        ...
        # Use "RISAT" if empty or equal to RISAT (case-insensitive)
        if not input_name or input_name.lower() == "risat":
            display_name = "RISAT"
        else:
    ...
    project_entry = Entry(frame1, textvariable=project_name_var, font=("Calibri", 11,"bold"),bg="lavender",fg="purple", width=15, justify="center")
    ...
    refresh_btn=Button(frame1,text="Refresh",width=15,font=("Calibri", 11,"bold"),bg="lavender",fg="purple",command=update_coms)
    ...
    file_entry1=Entry(frame1,width=15,font=("Calibri", 11,"bold"),bg="lavender",fg="purple")
    file_entry1.grid(column=6,row=1,pady=2,padx=2)
    connect_btn=Button(frame1,text="Connect",width=15,state="disabled",font=("Calibri", 11,"bold"),bg="lavender",fg="purple",command=connexion)
    ...
    ccsds=Label(frame4,text="CCSDS:",font=("Calibri", 11,"bold"),bg='lavender')
    ...
    position_label1 = Label(frame5, text="Y-Dx:",font=("Calibri", 11,"bold"),bg='lavender')
    ...
    position_label2 = Label(frame5, text="Z-Dx:",font=("Calibri", 11,"bold"),bg='lavender')
    ...
    Name1=Label(frame5,text=" ESTIMATED    :",padx=2, pady=2,font=("Calibri", 11,"bold"),bg='lavender')
    ...
    # ====================== CHECKSUM  and NO OF SAT=============================
    frame7=LabelFrame(root,text='CHECKSUM and No Of Sat',bg="lavender",
    fg="purple",
    font=("Calibri", 13, "bold"),
    relief="solid",         # makes edges visible(solid,ridge,raised,groove,sunken,flat)
    bd=2,                    # border thickness
    ...
    frame7.grid(row=0,column=4,padx=2, pady=2,sticky="nsew")
 
    
    
    
    
    # ======================== CLOCK AND DRIFT AND CHECKSUM====================
    
    frame9=LabelFrame(root,text='CLOCK & DRIFT & CHECKSUM',bg="lavender",
    fg="purple",
    font=("Calibri", 13, "bold"),
    relief="solid",         # makes edges visible(solid,ridge,raised,groove,sunken,flat)
    bd=2,                    # border thickness
    ...
    validation=Label(frame9,text="Clock bais:",font=("Calibri", 11,"bold"),bg="lavender")
    validation.grid(row=3, column=0)
    cb=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))
    cb.grid(column=1,row=3,padx=2, pady=2)
    
    Ivalidation=Label(frame9,text="Inter system bais:",font=("Calibri", 11,"bold"),bg="lavender")
    Ivalidation.grid(row=4, column=0)
    icb=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))
    ...
    drift=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))
    drift.grid(column=1,row=5,padx=2, pady=2)
    
    InterSystemDrift=Label(frame9,text="Inter system drift:",font=("Calibri", 11,"bold"),bg='lavender')
    InterSystemDrift.grid(row=6, column=0)
    isd=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))     
    isd.grid(column=1,row=6,padx=2, pady=2)
    
    validation=Label(frame9,text="Checksum SA2:",font=("Calibri", 11,"bold"),bg="lavender")
    validation.grid(row=7, column=0)
    csm=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))
    csm.grid(column=1,row=7,padx=2, pady=2)
    
    validation=Label(frame9,text="Checksum SA3:",font=("Calibri", 11,"bold"),bg="lavender")
    validation.grid(row=8, column=0)
    csm1=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))
    ...
    port1=Label(frame9,text="PORT1:",font=("Calibri", 11,"bold"),bg='lavender')
    port1.grid(row=7, column=0)
    port1=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))     
    port1.grid(column=1,row=7,padx=2, pady=2)
    
    port2=Label(frame9,text="PORT2:",font=("Calibri", 11,"bold"),bg='lavender')
    port2.grid(row=8, column=0)
    port2=Entry(frame9,width=10,state="readonly",font=("Calibri", 11,"bold"))             
    ...
    footer_label = Label(
        window,
        text="@ 2025 ISRO @ RISAT-1B Interface | Version 1.0",
...
def decode_wdt_status_word(status_word):
    ...
    result["Valid 1553 Command Counter"] = (status_word >> 10) & 0x3F
    ...
    result["SPS Software Status"] = "EEPROM Mode" if (status_word >> 4) & 1 else "PROM Mode"
...
def get_timestamped_filename(base_name: str, suffix: str) -> str:
    ...
    RISAT_YYYY-MM-DD_HH-MM-SS_BASENAME_SUFFIX.csv
    
    Example:
    RISAT_2025-08-21_20-35-10_MYDATA_PVT.csv
  
    """
    return f"RISAT_{SESSION_TIMESTAMP}_{base_name}_{suffix}.csv"
...
def write_to_SYNh2(data, base_name):
    file_name = get_timestamped_filename(base_name, "h2Time")
...
def write_to_csv(data, base_name):
    ...
    header = [
        'TimeStamp','Display_counter','SYS_Second','SYS_NanoSecond','SYS_WeekNumber',
        ...
        'Clock bais','InterSystem bais','Drift','Inter System Drift',
        'Last_cmd_B1_B2','Last_cmd_B3','Last_cmd_B4','ACQ1_SVID',
        'SWDT Reset Counter','HWDT Reset Counter','SWDT Reset ID','PB Storage Mode',
            ...
            if ser.in_waiting>0:
                ...
                if byte == header1[header_index1]:
                    ...
                    if header_index1 == len(header1):
                        ...
                        hexDecodedData = ''.join(header1)+ser.read(1026).hex()
                ...
                if byte == header2[header_index2]:
                    ...
                    if header_index2 == len(header2):
                        ...
                        hexDecodedData = ''.join(header2)+ser.read(1026).hex()
                ...
                if byte == header3[header_index3]:
                    ...
                    if header_index3 == len(header3):
                        ...
                        hexDecodedData = ''.join(header3)+ser.read(1026).hex()
                ...
                if byte == header4[header_index4]:
                    ...
                    if header_index4 == len(header4):
                        ...
                        hexDecodedData = ''.join(header4)+ser.read(1026).hex()
    ...
    try:
        while True:
                            ...
                            if data_type == "header1":
                                ...
                                CLOCKBAIS_hex = hexDecodedData[428:436] #SA4
                                ...
                                INTER_BAIS_hex = hexDecodedData[456:460]
                                
                                SWDT_RST_COUNTER_hex = hexDecodedData[476:478]
                                ...
                                Last_cmd_excuted_byte3_hex = hexDecodedData[490:492]
                                ...
                                sbas_fast_crr = hexDecodedData[512:516]  # Adjust index if needed
                                ...
                                CLOCKBAIS = reverse_and_concatenate(CLOCKBAIS_hex,is_signed=True)
                                PDOP = reverse_and_concatenate(PDOP_hex, is_signed=True)/100.0
                                INTER_SYSTEM_BAIS= reverse_and_concatenate(INTER_BAIS_hex,is_signed=True)/1000.0
                                ...
                                cb.delete(0,END)
                                cb.insert(0, f"{CLOCKBAIS}")
                                cb.config(state="readonly")
                                set_colored_value(cb,CLOCKBAIS)
                                ...
                                icb.delete(0,END)
                                icb.insert(0, f"{INTER_SYSTEM_BAIS}")
                                icb.config(state="readonly")
                                set_colored_value(icb,INTER_SYSTEM_BAIS)
                                ...
                                data_row = [current_timestamp,counter_value,SYS_Second,SYS_NanoSecond,SYS_Weeknumber,
                                            ...
                                            CLOCKBAIS,INTER_SYSTEM_BAIS,DRIFT,ISD,
                                ...
                                valid_1553_cmd_counter = decoded_wdt["Valid 1553 Command Counter"]
